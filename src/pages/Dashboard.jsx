import { useState, useEffect } from 'react';
  ...
  className="text-4xl text-green-500" />;
      if (type?.includes('presentation') || type?.includes('powerpoint')) return <BsFileEarmarkPpt className="text-4xl
  text-orange-500" />;
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex items-center justify-center p-2 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400
